...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="card">
            ...
            <div class="alert alert-success" id="success-alert" style="display:none; text-align:center;">
                ...
                <strong style="text-align:center">Outlet Added Successfully!</strong>
           </div>
            <div class="card-body">
                <form id="outlet_add_form" action="{{ url('store_outlet') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
    <script type="text/javascript">
      // Validation error message
        $(function(){
          $("#outlet_add_form").on('submit', function(e){
            e.preventDefault();
