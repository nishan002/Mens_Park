...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4020459829ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mens_park&table=categories">`mens_park`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mens_park&table=products">`mens_park`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mens_park&table=outlets">`mens_park`.`outlets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mens_park&table=users">`mens_park`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mens_park&table=migrations">`mens_park`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mens_park&table=failed_jobs">`mens_park`.`failed_jobs`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="222445454b277b6b23615d414f27362f">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="mens_park" targettable="categories">
            ...
            Queried time
                            ...
                            <span class="query">TRUNCATE TABLE products;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mens_park" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">TRUNCATE TABLE outlets;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mens_park" targettable="categories">
                            <div class="action_content">
